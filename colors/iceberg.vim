...
if &background == 'light'
  hi Normal ctermbg=255 ctermfg=237 guibg=#e8e9ec guifg=#33374c
  ...
  hi Whitespace ctermfg=252 guifg=#cbcfda
  ...
  hi LineNr ctermbg=252 ctermfg=259 guibg=#dcdfe7 guifg=#9fa7bd
  ...
  hi String ctermfg=22 guifg=#3f83a6
